...
const GOALS: { value: PrimaryGoal; label: string; desc: string }[] = [
  ...
  { value: 'hypertrophy', label: 'Muscle growth', desc: 'Volume and progression' },
  { value: 'endurance', label: 'Endurance', desc: 'More reps, lighter weights' },
  { value: 'weight_loss', label: 'Fat loss', desc: 'Calorie deficit and cardio' },
]
...
export default function OnboardingPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const message = 'Could not save your profile. Try again.'
  ...
  return (
    <AuthShell
      ...
      subtitle="You can change these settings later in your profile."
    >
      <form onSubmit={handleSubmit} className="onboarding-form flex flex-col gap-4" aria-describedby={submitError ? 'onboarding-submit-error' : undefined}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            aria-valuetext={`${weeklyGoal} out of 7`}
        ...
        <div className="flex flex-col gap-2" role="group" aria-labelledby="onboarding-units-label">
          <span id="onboarding-units-label" className="text-xs font-medium" style={{ color: 'var(--muted)' }}>Units</span>
